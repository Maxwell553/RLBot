...
class DataConfig:
    ...
    # "independent": features recomputed per segment over a causal preroll window of
    #   feature_preroll_bars earlier bars (sliced off after computation) so slow
    #   indicators get real warmup; only panel-head bars with insufficient preroll
