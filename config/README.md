...
| `vol_penalty_scale` | Penalize excess downside vol vs the passive benchmark: `scale × reward_scale × max(agent_downside_vol − benchmark_downside_vol, 0)` over the Sortino window (default **300.0**; `0` disables) |
